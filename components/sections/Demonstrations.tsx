    ...
    <section className="py-20 px-4 md:px-8 bg-card">
      <div className="max-w-6xl mx-auto">
              ...
              <div className="relative z-10 p-6 h-64 flex flex-col justify-between">
                <div>
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-4 group-hover:bg-primary group-hover:text-primary-foreground transition-all"
                  >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-12 p-8 md:p-12 bg-gradient-to-r from-primary/10 to-accent/10 rounded-lg border border-primary/20 overflow-hidden"
        >
